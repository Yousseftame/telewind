...
export function AnnouncementFormDialog({
  ...
  useEffect(() => {
    if (mode === "edit" && announcement) {
      ...
      setTranslations({
        en: { title: enTrans?.title || "", description: enTrans?.description || "" },
        ar: { title: arTrans?.title || "", description: arTrans?.description || "" },
        tw: { title: twTrans?.title || "", description: twTrans?.description || "" },
      });
    } else {
      setDate("");
      setType("");
  ...
  const updateTranslation = (lang: "en" | "ar" | "tw", field: "title" | "description", value: string) => {
              ...
              <TabsContent value="tw" className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateTranslation("tw", "title", e.target.value)}
                    required
                  />
                </div>
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) => updateTranslation("tw", "description", e.target.value)}
                    rows={4}
                    required
                  />
                </div>
